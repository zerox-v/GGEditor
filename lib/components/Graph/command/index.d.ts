declare const _default: {
  ...
  remove: import('./base').BaseCommand<
    import('./remove').RemoveCommandParams,
    import('../../../common/interfaces').Graph
  >;
  update: import('./base').BaseCommand<
    import('./update').UpdateCommandParams,
    import('../../../common/interfaces').Graph & import('../../../common/interfaces').TreeGraph
  >;
  ...
  pasteHere: import('./base').BaseCommand<
    import('./pasteHere').PasteHereCommandParams,
    import('../../../common/interfaces').Graph
  >;
